            ...
            'sections' => [
                ...
                [
                    ...
                    'paragraphs' => [
                        ...
                        'Depois de finalizada, o layout do PDF segue o padrão configurado para o médico e a clínica.',
                    ],
                    'bullets' => [],
                ],
            ],
            ...
            'sections' => [
                ...
                [
                    ...
                    'paragraphs' => [
                        ...
                        'Quando você sincroniza de novo, o sistema atualiza do Tiny itens como preço, custo, unidade e o vínculo com o produto no ERP; o nome só é preenchido automaticamente pelo Tiny se ainda estiver vazio no RevSkin. Já descrição/fórmula, modo de uso, anotações, anotações internas e o texto do nome que você já salvou não são sobrescritos por novas sincronizações.',
                    ],
                    'bullets' => [
            ...
            'sections' => [
                ...
                [
                    ...
                    'paragraphs' => [
                        ...
                        'Depois de salvar Client ID e Secret, use Autorizar aplicativo para concluir o OAuth: o RD Station redireciona de volta ao RevSkin e os tokens ficam armazenados. O botão Testar conexão confirma se a API responde com o token atual.',
