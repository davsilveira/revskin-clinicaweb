            ...
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 px-4">
                <div className="max-w-md w-full">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <h1 className="text-3xl font-semibold text-zinc-700 mb-2">
                            Bem-vindo de volta
                        </h1>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className={`w-full pl-10 pr-12 py-3 h-[44px] bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:bg-white transition-all duration-200 ${
