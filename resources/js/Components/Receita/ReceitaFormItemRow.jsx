    ...
    return (
        ...
        >
            ...
            <div className="w-full min-w-0 lg:flex-[3]">
                ...
                />
                {isLegado && (
                    <p className="mt-1 flex items-center gap-1.5 text-xs font-medium leading-4 text-red-600">
                        <svg
                        ...
                        <span className="min-w-0">Produto descontinuado — substitua para poder salvar ou finalizar.</span>
                    </p>
                )}
            </div>
