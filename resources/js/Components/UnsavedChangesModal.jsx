    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-center justify-center overflow-y-auto p-4">
            <button
                type="button"
                aria-label="Fechar"
                className="fixed inset-0 z-[61] bg-black/50 transition-opacity cursor-default border-0 p-0"
                onClick={onCancel}
            />
            <div className="relative z-[62] w-full max-w-md rounded-xl bg-white p-6 shadow-xl transform transition-all">
