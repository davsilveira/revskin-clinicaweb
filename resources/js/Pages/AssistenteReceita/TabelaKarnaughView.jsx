    ...
    return (
        <DashboardLayout title={`Tabela: ${tabela.nome}`}>
            <div className="py-4 lg:py-6 px-0">
                    ...
                    <div className="flex items-center gap-4 w-full lg:w-auto">
                        <div className="relative w-full lg:w-64">
                            <input
                                ...
                                className="pl-10 pr-4 py-2.5 text-base w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
                            />
                ...
                {/* Estatísticas — mobile: coluna única; tablet: 2+arquivo em linha de baixo; lg+: três colunas */}
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4 lg:grid-cols-3 mb-6">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:col-span-2 lg:col-span-1 min-w-0">
                        <div className="flex items-start justify-between gap-2 min-w-0">
                            <div className="min-w-0 flex-1">
                                <p className="text-sm text-gray-500">Arquivo Original</p>
                                <p className="text-sm font-medium text-gray-900 break-words">{tabela.arquivo_original || '-'}</p>
                            </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-6">
                    <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:gap-x-6 sm:gap-y-2 text-sm">
                        ...
                        <div className="flex items-center gap-2 min-w-0">
                            <span className="w-3 h-3 flex-shrink-0 bg-emerald-100 border border-emerald-300 rounded"></span>
                            <span className="text-gray-700">Primeiro Grupo (pré-selecionado)</span>
                        </div>
                        <div className="flex items-center gap-2 min-w-0">
                            <span className="w-3 h-3 flex-shrink-0 bg-gray-100 border border-gray-300 rounded"></span>
