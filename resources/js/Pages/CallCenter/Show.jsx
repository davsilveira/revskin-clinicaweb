                            ...
                            <div className="space-y-3">
                                ...
                                {atendimento.paciente?.telefone && (
                                    <div>
                                        ...
                                        <a
                                            href={`tel:${atendimento.paciente.telefone}`}
                                ...
                                {atendimento.paciente?.celular && (
                                    <div>
                                        <label className="text-sm text-gray-500">Celular/WhatsApp</label>
                                        <a
                                            href={`https://wa.me/55${atendimento.paciente.celular.replace(/\D/g, '')}`}
                                            target="_blank"
                                ...
                                {atendimento.paciente?.email && (
                                    <div>
                                        ...
                                        <a
                                            href={`mailto:${atendimento.paciente.email}`}
