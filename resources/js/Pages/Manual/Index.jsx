...
export default function ManualIndex({ modules = [] }) {
    ...
    return (
        <>
            ...
            <DashboardLayout>
                <div className="max-w-6xl mx-auto space-y-6 lg:space-y-8 pb-8">
                    <div className="rounded-xl border border-emerald-100 bg-gradient-to-r from-emerald-50 via-white to-gray-50/80 shadow-sm px-5 py-6 sm:px-8 sm:py-7 border-l-4 border-l-emerald-600">
                        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                            <div className="min-w-0">
                                <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight">Manual de uso</h1>
                                <p className="mt-2 text-base text-gray-600 max-w-prose leading-relaxed">
                                    Documentação por módulo. Use o índice ao lado (em telas grandes) ou os atalhos para
                                    navegar. A busca filtra tópicos e trechos.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:grid lg:grid-cols-[minmax(0,240px)_1fr] lg:gap-8 xl:gap-10 items-start">
                        <nav
                        ...
                        <div className="min-w-0 space-y-10 lg:space-y-12">
                            {emptySearch && (
                                <div className="rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-900">
                                    Nenhum trecho encontrado para &quot;{trimmed}&quot;. Tente outras palavras ou limpe a
                                    busca.
                                </div>
                            )}
                            ...
                            {filtered.map((mod) => (
                                ...
                                >
                                    <header className="flex items-center gap-4 px-5 py-4 sm:px-6 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                                        ...
                                        <h2 className="text-xl font-semibold text-gray-900 tracking-tight">{mod.title}</h2>
                                    </header>
                                    <div className="px-5 py-6 sm:px-8 sm:py-8 max-w-prose">
